...
class Pcsx2Generator(Generator):
	...
	#PCSX2 Custom settings mod

        #custom_config_path = "/userdata/roms/ps2/custom_configs/"+ rom.split('/')[-1]
        custom_config_path = "/userdata/pcsx2_custom_configs/games/"+ rom.split('/')[-1]
        custom_config_ini_path = custom_config_path+"/inis/"
        pcsx2_ini = "/userdata/system/configs/PCSX2/inis/"

	if not os.path.exists(custom_config_ini_path):
		os.makedirs(custom_config_ini_path)

	ini_clone(pcsx2_ini, custom_config_path, "GSdx.ini")
	ini_clone(pcsx2_ini, custom_config_path, "OnePAD.ini")
	ini_clone(pcsx2_ini, custom_config_path, "PCSX2_ui.ini")
	ini_clone(pcsx2_ini, custom_config_path, "PCSX2_vm.ini")
	ini_clone(pcsx2_ini, custom_config_path, "spu2-x.ini")
	ini_clone(pcsx2_ini, custom_config_path, "USBnull.ini")
	ini_clone(pcsx2_ini, custom_config_path, "Dev9null.ini")
	ini_clone(pcsx2_ini, custom_config_path, "FWnull.ini")

        shutil.copy("/usr/lib/python2.7/site-packages/configgen/generators/pcsx2/pcsx2-custom-config", custom_config_path)

	commandArray.append("--cfgpath="+custom_config_path+"/inis")

	#End PCSX2 Custom settings mod
...
# ini_clone Function for the PCSX2 Custom settings mod

def ini_clone(pcsx2_ini, custom_config_path, ini_filename):
	custom_config_ini_path = custom_config_path+"/inis/"
